...
describe.each([
  {
    ...
    assets: [
      ...
      'react-native-bundle-output/src_Async_js.chunk.bundle',
      'react-native-bundle-output/src_Async_js.chunk.bundle.map',
      'assets/src/callstack-dark.png',
  ...
  },
  {
    ...
    assets: [
      ...
      'drawable-mdpi/src_callstackdark.png',
