...
Additionally, we've overhauled the [hot module replacement](https://webpack.js.org/concepts/hot-module-replacement/) (HMR) logic, which was previously a major pain point, and now works not only across federated apps, but also in a more predictable and reliable manner.
