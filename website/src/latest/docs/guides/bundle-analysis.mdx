...
<Tabs groupId="bundler">
  <Tab label="Rspack" value="rspack">
    <PackageManagerTabs command={{
      npm: 'npm install @rsdoctor/rspack-plugin@0.4.13 -D',
      yarn: 'yarn add @rsdoctor/rspack-plugin@0.4.13 -D',
      pnpm: 'pnpm add @rsdoctor/rspack-plugin@0.4.13 -D',
      bun: 'bun add @rsdoctor/rspack-plugin@0.4.13 -D',
    }} />
  </Tab>
