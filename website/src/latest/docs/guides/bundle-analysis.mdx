...
<Tabs groupId="bundler">
  <Tab label="Rspack" value="rspack">
    <PackageManagerTabs command={{
      npm: 'npm install @rsdoctor/rspack-plugin@1.3.11 -D',
      yarn: 'yarn add @rsdoctor/rspack-plugin@1.3.11 -D',
      pnpm: 'pnpm add @rsdoctor/rspack-plugin@1.3.11 -D',
      bun: 'bun add @rsdoctor/rspack-plugin@1.3.11 -D',
    }} />
  </Tab>
