...
**Rsdoctor** is a recommended build analyzer that can visually display the build process. It provides insights into compilation time, compilation transformations, module dependencies, duplicate modules, and bundle size analysis. Bundle analysis helps you understand your app's performance bottlenecks and identify opportunities for optimization.
...
:::info title="Only for development"
