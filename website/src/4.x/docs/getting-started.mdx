...
To create a new React Native project with Re.Pack:

{/* prettier-ignore-start */}

<Steps>
  ### Initialize a new project using React Native CLI 
  ```bash 
...
If your existing project retains the structure of React Native template then you can skip to the last step and use the `@callstack/repack-init` CLI on its own.
...
Keep in mind that, you might need to adjust [Webpack config](./placeholder) to your project in order to the application to work correctly. It's impossible for us to know what your project looks like and uses, so it's recommended to read through the Webpack config's code and comments and make sure you understand what's going on there.
...
In case your project structure differs from the default React Native template, you can follow these manual installation steps:
