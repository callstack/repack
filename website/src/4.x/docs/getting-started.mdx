...
<Steps>
  ### [Optional] Initialize a new project using React Native CLI 
  ```bash 
...
Keep in mind that, you might need to adjust [Webpack config](./placeholder) to your project in order for the application to work correctly. It's impossible for us to know what your project looks like and uses, so it's recommended to read through the Webpack config's code and comments and make sure you understand what's going on there.
