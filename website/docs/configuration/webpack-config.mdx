...
import webpackConfig from '!!raw-loader!../../../templates/webpack.config.js';

<CodeBlock className="language-js" title="templates/webpack.config.js">{webpackConfig}</CodeBlock>
...
- [AssetsPlugin](/docs/api/classes/AssetsPlugin)
- [DevServerPlugin](/docs/api/classes/DevServerPlugin)
- [LoggerPlugin](/docs/api/classes/LoggerPlugin)
- [OutputPlugin](/docs/api/classes/OutputPlugin)
- [TargetPlugin](/docs/api/classes/TargetPlugin)
- [JavaScriptLooseModePlugin](/docs/api/classes/JavaScriptLooseModePlugin)
...
- [getContext](/docs/api/functions/getContext)
- [getDevServerOptions](/docs/api/functions/getDevServerOptions)
- [getEntry](/docs/api/functions/getEntry)
- [getMode](/docs/api/functions/getMode)
- [getPlatform](/docs/api/functions/getPlatform)
- [getReactNativePath](/docs/api/functions/getReactNativePath)
- [isMinimizeEnabled](/docs/api/functions/isMinimizeEnabled)
- [getInitializationEntries](/docs/api/functions/getInitializationEntries)
- [getPublicPath](/docs/api/functions/getPublicPath)
- [getResolveOptions](/docs/api/functions/getResolveOptions)

> It entirely possible not to use the functions above, but **it's highly recommended to leave them**.

If you're planning on using Webpack CLI to run development server or bundle your application instead of replying on React Native CLI, then you might want to look into providing `fallback` values to each of these functions, for example:
