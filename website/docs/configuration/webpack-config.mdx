...
- [AssetsPlugin](/docs/api/repack/classes/AssetsPlugin)
- [DevelopmentPlugin](/docs/api/repack/classes/DevelopmentPlugin)
- [LoggerPlugin](/docs/api/repack/classes/LoggerPlugin)
- [OutputPlugin](/docs/api/repack/classes/OutputPlugin)
- [TargetPlugin](/docs/api/repack/classes/TargetPlugin)
- [JavaScriptLooseModePlugin](/docs/api/repack/classes/JavaScriptLooseModePlugin)
...
- [getAssetExtensionsRegExp](/docs/api/repack/functions/getAssetExtensionsRegExp)
- [getInitializationEntries](/docs/api/repack/functions/getInitializationEntries)
- [getPublicPath](/docs/api/repack/functions/getPublicPath)
- [getResolveOptions](/docs/api/repack/functions/getResolveOptions)
