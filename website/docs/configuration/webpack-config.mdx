...
- [AssetsPlugin](/docs/api/node/classes/AssetsPlugin)
- [DevServerPlugin](/docs/api/node/classes/DevServerPlugin)
- [LoggerPlugin](/docs/api/node/classes/LoggerPlugin)
- [OutputPlugin](/docs/api/node/classes/OutputPlugin)
- [TargetPlugin](/docs/api/node/classes/TargetPlugin)
- [JavaScriptLooseModePlugin](/docs/api/node/classes/JavaScriptLooseModePlugin)
...
- [getContext](/docs/api/node/functions/getContext)
- [getDevServerOptions](/docs/api/node/functions/getDevServerOptions)
- [getEntry](/docs/api/node/functions/getEntry)
- [getMode](/docs/api/node/functions/getMode)
- [getPlatform](/docs/api/node/functions/getPlatform)
- [getReactNativePath](/docs/api/node/functions/getReactNativePath)
- [isMinimizeEnabled](/docs/api/node/functions/isMinimizeEnabled)
- [getInitializationEntries](/docs/api/node/functions/getInitializationEntries)
- [getPublicPath](/docs/api/node/functions/getPublicPath)
- [getResolveOptions](/docs/api/node/functions/getResolveOptions)
