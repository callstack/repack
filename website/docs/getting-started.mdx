...
<Tabs>
<TabItem value="current-rn" label="React Native version 0.69.0 or newer" default>
...
<TabItem value="old-rn" label="React Native version below 0.69.0" default>
...
<Tabs>
<TabItem value="current-rn" label="React Native version 0.71.0 or newer" default>
...
<TabItem value="old-rn" label="React Native version below 0.71.0" default>
