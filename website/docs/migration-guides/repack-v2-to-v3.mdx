...
Despite build errors related with Webpack config, you should also tackle changes related to `ChunkManager`.

Not only name has changed to `ScriptManager`, underlying logic was also affected. Full list of changes related to `ChunkManager` is [here](https://github.com/callstack/repack/blob/v3/packages/repack/CHANGELOG.md#300-next0)

From migration perspective below has to be done:
